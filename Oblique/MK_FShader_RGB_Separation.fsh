...
void main()
{
    ...
    highp float redTextureColor = texture2D(inputImageTexture, vec2(textureCoordinate.x - remappedX, textureCoordinate.y - remappedY)).r;
    highp float greenTextureColor = texture2D(inputImageTexture, textureCoordinate).g;
    highp float blueTextureColor = texture2D(inputImageTexture, vec2(textureCoordinate.x + remappedX, textureCoordinate.y + remappedY)).b;
